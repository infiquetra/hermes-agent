...
- **Interim assistant commentary** (for example, "I'll check that") is shown in chat by default but is **not** spoken in voice by default. Opt in with `display.platforms.discord.speak_interim_assistant_messages: true`.
